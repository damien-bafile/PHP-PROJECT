 ...
 * @package    PackageName
 * @author     Damien Bafile M036449@tafe.wa.edu.au
...
$searchTitle = $searchGenre = $searchRating = $searchYear = "";?>
    <div class="container">
        ...
        <?php require_once 'include/inc_nav_index.php';?></div>
        <div class="content"><?php require_once 'include/inc_content.php';?></div>
        <div class="search"><?php require_once 'include/inc_search.php';?></div>
